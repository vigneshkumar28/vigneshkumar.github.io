    ...
    >
      <q-list style="max-height: calc(100% - 48px);overflow-y: auto; -webkit-overflow-scrolling: touch;">
        ...
        >
          ...
          <div class="text-center text-bold text-secondary q-mt-md full-width text-h5">Vigneshkumar R</div>
          <div class="text-center full-width" :class="$q.dark.isActive ? 'text-white' : 'text-primary'" style="font-size: 12px">Never <br> Ever GiveUp</div>
...
export default {
  ...
  data () {
    return {
      ...
      menuClicked: false,
      roles: ['Ready to Learn and work with You', 'Full stack developer', 'Data scientist', 'Looking for job'],
      essentialLinks: [
        {
          title: 'Home',
          caption: 'Home Page',
        ...
        {
          title: 'Projects',
          caption: 'I have worked on some basic projects',
          icon: 'assignment',
          link: '/projects'
        },
        {
...
.menu-img
  ...
  width 100px
  margin auto
  background url('../statics/vignesh.jpg') no-repeat
