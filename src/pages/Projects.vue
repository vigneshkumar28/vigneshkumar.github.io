  ...
  <q-page class="flex projects-page">
    <div
      class="
        ...
        row
        items-start
        justify-md-between justify-center
        q-gutter-md
      "
    >
      <q-card
        ...
        bordered
      >
        <q-img width="298px" height="160px" :src="project.img" />
        <q-card-section>
