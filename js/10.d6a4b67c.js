(window["webpackJsonp"]=window["webpackJsonp"]||[]).push([[10],
    {c52d:function(e,a,n){},ca53:function(e,a,n){"use strict";var l=n("c52d"),
    t=n.n(l);t.a},
    e2de:function(e,a,n){"use strict";n.r(a);var l=function()
    {var e=this,a=e.$createElement,n=e._self._c||a;
        return n("q-page",
        {staticClass:"flex justify-around content-start skills-pg q-pa-sm"},
        [n("q-input",{staticClass:"full-width q-mt-xl q-px-xl",
        attrs:{dark:e.$q.dark.isActive,outlined:"",clearable:"",debounce:"500",
        placeholder:"Search Skill"},scopedSlots:e._u([{key:"append",fn:function()
        {return[n("q-avatar",[n("q-icon",{attrs:{name:"search"}})],1)]},proxy:!0}]),
        model:{value:e.search,
            callback:function(a){e.search=a},expression:"search"}}),
            n("div",{staticClass:"q-mt-md full-width flex justify-center"},
        [n("div",{staticClass:"text-warning",
        staticStyle:{"padding-top":"14.5px"}},[e._v("Graph")]),n("q-toggle",
        {staticClass:"text-warning",attrs:{dark:e.$q.dark.isActive,
            color:"accent",size:"lg",label:"List"},
        model:{value:e.is_list,callback:function(a){e.is_list=a},
        expression:"is_list"}})],1),e._l(e.filtered_skills,
            (function(a){return n("div",{key:a.name},
        ...
        e._l(a.skills,(function(a){return n("div",{key:a.name,
            staticClass:"flex-wrap justify-start items-center",
        class:e.is_list?"justify-center q-my-sm":"column"},[e.is_list?e._e():
            n("q-circular-progress",{staticClass:"q-ma-md text-accent row",
            attrs:{"show-value":"","font-size":"10px",value:a.value,size:"80px",
            thickness:.25,
        color:"secondary","track-color":e.$q.dark.isActive?"primary":"white"}}),
        n("div",{staticClass:"text-bold text-warning text-center",
        staticStyle:{"max-width":"110px","text-wrap":"wrap"}},
        [e._v(e._s(a.name))])],1)})),0):e._e()])}))],2)},t=[],s=(n("7f7f"),
        n("386d"),
        ...
        {name:"Programming Languages",skills:[{name:"Java",value:90},
        {name:"C",value:90},{name:"C++",value:70},
       ...
       // {name:"Babel",value:90},{name:"GraphQL",value:60}
        ...
        {name:"Atom",value:70},{name:"Sublime",value:90},
        ...
        {name:"Arduino / Raspberry Pi",value:90},{name:"IBM Cloud",value:90},
        {name:"Watson platform",value:90}]},
        

        {name:"Non Technical Skills",
        skills:[{name:"Cooking / Baking",value:90},
        ...
        {name:"Microprocessor and Microcontroller (MPMC)",value:80},
        {name:"Data structures and algorithms (DSA)",value:90},
        {name:"Object Orientation Programming and Structures (OOPS)",value:90},
        {name:"Web development essential : HTML, CSS, PHP, JavaScript",value:80},
        {name:"Digital Electronics",value:90},
        {name:"Analog Communications",value:90},
        {name:"Digital Communications",value:80},
        {name:"Data Communication and Networks (DCN)",value:90},
        {name:"Digital Signal Processing (DSP)",value:90},
        {name:"Signals and systems (SS)",value:80},
        {name:"Semiconductor Fabrications",value:90},
        {name:"Programming language : C, C++, Java",value:90},
